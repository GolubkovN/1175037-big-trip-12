...
const createNewPointFormTemplte = (point = {}) => {
  const {type, destination, information, pointPrice, timeStart, timeEnd} = point;
...
export default class AddPoint extends Abstract {
  ...
  _getTemplate() {
    return createNewPointFormTemplte(this._point);
  }
