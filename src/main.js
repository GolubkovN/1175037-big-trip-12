...
const createHeaderControlsTemplate = () => {
  return (
...
const createEventsOffersTemplate = () => {
  return (
...
const createEventsDestinationTemplate = () => {
  return (
...
render(menuElement, createHeaderInfoTemplate(), `afterBegin`);
...
render(eventDetailsElement, createEventsOffersTemplate(), `beforeend`);
...
for (let i = 0; i < 3; i++) {
  render(dotsListElement, createDotsTemplate(), `beforeend`);
}
